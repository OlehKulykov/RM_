...
if [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_BRANCH" == "master" ]; then
    ...
    jazzy --clean --author "Oleh Kulykov" --author_url http://www.resident.name --github_url https://github.com/OlehKulykov/RM_ --xcodebuild-arguments "-scheme,RM_" --module RM_ --root-url http://olehkulykov.github.io/RM_ --theme apple --swift-version 3.0.2 --min-acl public --readme README.md
